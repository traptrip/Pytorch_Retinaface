...
from .backbone_models.net import MobileNetV1 as MobileNetV1
from .backbone_models.net import FPN as FPN
from .backbone_models.net import SSH as SSH
...
class RetinaFace(nn.Module):
    def __init__(self, cfg=None, phase='train'):
        ...
        if cfg['name'] == 'mobilenet0.25':
            ...
            if cfg['pretrain']:
                checkpoint = torch.load(cfg['weights_path'], map_location=torch.device('cpu'))
